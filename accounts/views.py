...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            profile.profile_picture = 'default/default_profile_pic.jpg'
            profile.save()
            ...
            #messages.success(request, 'Thanks for registering with us! Please check your email for verification link.')
